...
-- 국가코드
insert into TC_NATION (NATION_CODE, NATION_NAME_KOREA, NATION_NAME_ENGLISH, CONTINENT_CODE)values('410','대한민국','KOREA REPUBLIC OF','00');
insert into TC_NATION (NATION_CODE, NATION_NAME_KOREA, NATION_NAME_ENGLISH, CONTINENT_CODE)values('392','일본','JAPAN','00');
